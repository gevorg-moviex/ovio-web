...
export default function Login() {
    ...
    return (
        <div className="py-9 mt-14 h-[72vh] flex justify-center items-center text-[#101828]">
            <form action="" onSubmit={handleLogin} className="flex w-auto px-3 product560x:px-0 product560x:w-[480px] h-[352px] border-none outline-none flex-col justify-center gap-6 text-sm">
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col relative gap-1 text-[#858585] tracking-wide">
                        ...
                        {error2 && (
                            <span className="text-xs text-red-600">{conditionsAm.loginError}</span>
                        )}
                    </div>
                ...
                <div className="flex justify-center">
                    <div className="flex w-[60%] flex-col justify-center gap-3 items-center">
                        ...
                        <button type="submit" onClick={handleLogin} className="rounded-xl outline-none w-full hover:opacity-80 transition-all duration-300 font-semibold bg-[#53079d] px-6 text-white tracking-wide py-4">Մուտք</button>
                    </div>
                </div>
