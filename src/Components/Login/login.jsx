                ...
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col relative gap-1 text-[#858585] tracking-wide">
                        ...
                        <input 
                            ...
                            className="border focus:shadow-register transition-all text-[#101828] duration-200 border-[#e3e8ec] h-14 text-base pl-11 rounded-xl outline-none" 
                        />
                    ...
                    <div className="flex flex-col relative gap-1 text-[#858585]">
                        ...
                        <input 
                            ...
                            className="border border-[#e3e8ec] focus:shadow-register text-[#101828] transition-all duration-200 h-14 text-base pl-11 rounded-xl outline-none" 
                        />
                ...
                <div className="flex justify-center mt-5">
                    <div className="flex w-[70%] flex-col justify-center gap-3 items-center text-center">
                        ...
                        <Link to="/register" className="w-full">
                            <button type="button" className="rounded-2xl outline-none w-[80%] hover:bg-[#101828] hover:text-white transition-all duration-300 font-semibold text-[#101828] border border-[#101828] px-6 tracking-wide py-3">{language == "am" ? "Գրանցվել հիմա" : language == "en" ? "Register now" : language == "ru" ? "Зарегистрируйтесь сейчас" : null}</button>
                        </Link>
                    </div>
                </div>
            </form>
