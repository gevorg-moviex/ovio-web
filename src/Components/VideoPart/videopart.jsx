export default function VideoPart() {
    return (
        <div className="flex mt-14 justify-center items-center flex-col relative">
            ...
            <div className="rounded-[28px] absolute -bottom-24 shadow-topSide py-7 product805x:py-14 bg-white border-none outline-none flex flex-col gap-2 items-center w-[90%]">
